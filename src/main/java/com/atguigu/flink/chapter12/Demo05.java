...
public class Demo05 {
    public static void main(String[] args) {
        ...
        streamTableEnvironment.connect(new FileSystem().path("output/sensor_id.txt")).withFormat(new Csv().fieldDelimiter('|')).withSchema(schema).createTemporaryTable("sensor");
